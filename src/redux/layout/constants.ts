...
export interface LayoutStateTypes {
  ...
  topBarTheme: TopBarTheme.TOPBAR_LIGHT | TopBarTheme.TOPBAR_DARK | TopBarTheme.TOPBAR_BRAND | TopBarTheme.TOPBAR_GRADIENT;
  sideBarTheme: SideBarTheme.LEFT_SIDEBAR_THEME_LIGHT | SideBarTheme.LEFT_SIDEBAR_THEME_DARK | SideBarTheme.LEFT_SIDEBAR_THEME_BRAND | SideBarTheme.LEFT_SIDEBAR_THEME_GRADIENT;
